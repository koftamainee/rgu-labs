...
int program_00_10() {
    printf("MATRIX 1:\n");
    double **matrix1;
    random_matrix_generate(&matrix1, MATRIX_HEIGHT_1, MATRIX_WIDTH_1, 100,
                           -100);
    matrix_print(&matrix1, MATRIX_HEIGHT_1, MATRIX_WIDTH_1);
    printf("MATRIX 2:\n");
    double **matrix2;
    random_matrix_generate(&matrix2, MATRIX_HEIGHT_2, MATRIX_WIDTH_2, 100,
                           -100);
    matrix_print(&matrix2, MATRIX_HEIGHT_2, MATRIX_WIDTH_2);

    if (MATRIX_WIDTH_1 != MATRIX_HEIGHT_2) {
        printf(
            "Matrix multiplication not possible: Matrix1's width (%d) doesn't "
